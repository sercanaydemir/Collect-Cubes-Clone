...
namespace S_Utils.FoV
{
    public class FieldOfView : MonoBehaviour
    {
        ...
        [SerializeField] private bool drawFOVArea;
        ...
        public void StartScanTarget()
        {
            InvokeRepeating(nameof(FindVisibleTargets),0.2f,0.2f);
        }

        public void StopScanTarget()
        {
            CancelInvoke(nameof(FindVisibleTargets));
        }
